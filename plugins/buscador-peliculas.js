...
if (command == 'filmeshd') aaaa = await searchP(text)
...
if (command == 'filmeshd') img = 'https://i.imgur.com/ZVMEsEj.png?1'
...
handler.command = ['cuevana', 'filmeshd']
handler.level = 2
handler.money = 40
...
const $ = await safeLoad(`https://megafilmeshd50.com/?s=`, {
