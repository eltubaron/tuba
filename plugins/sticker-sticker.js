...
if (new Date - user.lastmiming < 10000) return await conn.reply(m.chat, `*ESPERE ALGUNS SEGUNDOS PARA USAR NOVAMENTE*`,  m)
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      await conn.reply(m.chat, `${eg}⏳ *CRIANDO FIGURINHA, UM MOMENTO...* 🦈`, m)
        if (!stiker) {
