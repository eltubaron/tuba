...
let sgh = md
let sgc = nnn
let gata = 'https://i.imgur.com/8sNHvJa.jpg'
...
//global.enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '🦈𝗦𝘂𝗽𝗲𝗿 SharkBOT', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
...
function ucapan() {
  const time = moment.tz('America/Sao_Paulo').format('HH')  //America/Sao_Paulo  Asia/Jakarta   America/Toronto
