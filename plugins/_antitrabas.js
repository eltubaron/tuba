...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "51995386439-1616969743@g.us","inviteCode": "m","groupName": "P", "caption": 'shark-ʙᴏᴛ', 'jpegThumbnail': null}}}
   if (chat.antiTraba && m.text.length > 280) { //Cantidad máxima de caracteres aceptados en un mensaje//
