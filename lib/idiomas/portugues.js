...
const smsLista1 = () => { return `🌟 INFORMAÇÕES DO SharkBOT 🌟`}
...
const smsLista7 = () => { return `🦈 INSTALAR O SharkBOT 🦈`}
...
//_allantilink.js
const smsTextoYT = () => { return '🦈 Super SharkBOT - WhatsApp '}
...
const smsAllAdmin = () => { return `*PRECISO SER ADMINISTRADOR PARA REMOVER ESSES MERDAS*`}
...
const smsToxic7 = () => { return `VOCÊ IGNOROU TODOS OS AVISOS AGORA VOCÊ SERÁ BANIDO 🙄`}
...
const smsModP2 = () => { return `Ativar função para que todos possam usar o SharkBOT`}
const smsModAd1 = () => { return `🛂 MODO ADMINISTRADOR`}
const smsModAd2 = () => { return `Apenas Admins poderão usar o SharkBOT em Grupos`}
...
const smsAdveu8 = () => { return '*AGORA VOCÊ SERÁ BANIDO* 🙄'}
const smsAdveu9 = () => { return '😇 OBRIGADO'}
...
const smskick3 = () => { return `NÃO CONSIGO BANIR O CRIADOR DO GRUPO 😆🫵`}
...
const smsPropban5 = () => { return `${lenguajeGB['smsAvisoEG']()}*USUARIO BANIDO COM SUCESSO* 🦈`}
...
const smsContacto2 = () => { return 'Eu sou o dono do ' + packname + ' se você tiver alguma dúvida, você pode me dizer ✌️'}
const smsContacto3 = () => { return '👑 Proprietário'}
const smsContacto4 = () => { return 'Contato Oficial SHARK BOT 🦈'}
